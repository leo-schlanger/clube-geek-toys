...
| `order-shipped`               | Pedido enviado                                   | Rastreio digitado, ou postagem lida pelo sync do Melhor Envio | name, order_number, tracking_code, tracking_url, shipping_service       | Cliente      |
